...
function Strategy(options, verify) {
    options = options || {};
    options.authorizationURL = options.authorizationURL || options.authorizationUrl || 'http://auth.ifsta.org/dialog/authorize';
    options.tokenURL = options.tokenURL || options.tokenUrl || 'http://auth.ifsta.org/oauth/token';
    ...
    this._profileURL = options.profileURL || options.profileUrl || 'http://auth.ifsta.org/api/userinfo';
